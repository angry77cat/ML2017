...
model_dir = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'best_models/')
...
def main():
	...
	pred = np.zeros((te_UserID.shape[0], 1))

	for i in range(20):
		path= os.path.join(model_dir, 'model'+str(i)+'.h5')
